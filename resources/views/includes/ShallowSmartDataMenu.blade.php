<?php function ShallowSmartDataMenu($SmartDataArrayShowBaseLocation,$SmartDataArrayName, $SmartDataItemM_ShowActions){ ?>
  <div class="" style="  z-index: 1;position: relative;">
    ...
    <button type="submit" name="<?php echo $SmartDataItemM_ShowActions['ShallowSmartDataStore'] ?>" value="<?php echo $SmartDataArrayShowBaseLocation.$SmartDataArrayName ?>">Store</button>
